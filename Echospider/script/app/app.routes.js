System.register(["@angular/router", "./home.component", "./about.component", "./contact.component", "./signup.component", "./login.component", "./users.component", "./_guards/auth.guard"], function (exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var router_1, home_component_1, about_component_1, contact_component_1, signup_component_1, login_component_1, users_component_1, auth_guard_1, routes, routing;
    return {
        setters: [
            function (router_1_1) {
                router_1 = router_1_1;
